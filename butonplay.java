...
/**
 * Write a description of class butonplay here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class butonplay extends Actor
{
    /**
     * Act - do whatever the butonplay wants to do. This method is called whenever
   ...
   public butonplay()
    ...
    public butonplay(World nextWorld)
    {
...
private void touchButton()
{
        ...
        {
            Greenfoot.setWorld(nextWorld); // schimbă lumea
        }
